...
const Section5 = () => {
  return (
    <section className="Section5 flex justify-center items-center bg-white py-10 px-5 text-[#02033B]">
      <div className="Content flex flex-col lg:flex-row gap-10  ">
...
"
        ...
        <div className="RightSection flex flex-col items-start w-full  md:w-[19.25rem] justify-start gap-7 rounded-[3rem]   p-[3rem]">
