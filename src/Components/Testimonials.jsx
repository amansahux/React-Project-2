    ...
    <section className="Testimonials bg-gradient-to-b from-[#F7C95F] to-[#FDB235] w-full py-16 gap-8">
      ...
      <div className="Reviews flex items-center justify-center sm:justify-start overflow-x-auto mx-auto">
        {ReviewData.map((elem, idx) => (
          <div
            key={idx}
            style={{ boxShadow: "12px 12px 20px 0 rgba(0, 0, 0, 0.10)" }}
            className="flex w-[350px] h-[350px] p-[2rem] flex-col justify-center items-center md:justify-start md:items-start gap-[1.5rem] rounded-[3rem] shrink-0 bg-white mx-10 "
          >
      ...
      <div className="Companyies hidden xl:flex justify-start items-center p-20 gap-20">
        ...
        <div className="SVGs flex gap-[2.25rem] items-center">
          ...
          <img src={FinantialTiming} alt="Financial Timing" />
